  ...
  implements ProtoSerializable<IStructuredPipeline>
{
  ...
  _validateUserData(ignoreUndefinedProperties: boolean): void {
    // Structured pipeline options are primitive configurations or raw overrides.
    // They do not contain Abstract Syntax Tree expressions that require deferred user data validation.
  }
}
